class ResultScene extends Scene{
  ...
  void draw() {
    ...
    textSize(50);
    text("perfect:"+Integer.toString(scoreBoard.perfect), 300, 400);
    text("good:"+Integer.toString(scoreBoard.good), 300, 450);
    text("miss:"+Integer.toString(scoreBoard.miss), 300, 500);
    textSize(30);
